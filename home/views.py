...
def pdf_view_cs(request):
	with open(os.path.join(os.path.dirname(os.path.realpath(__file__)),'Xiao_Wei_ResumeCS_10_2_13.pdf'),'rb') as pdf:
		response = HttpResponse(pdf.read(), content_type='application/pdf')
		response['Content-Disposition'] = 'inline; filename =Xiao_Wei_ResumeCS_10_2_13.pdf'
		return response
